...
/* harmony import */ var _components_swiper_page2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/swiper-page2 */ "./src/js/components/swiper-page2.js");
/* harmony import */ var _components_fullpageswiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/fullpageswiper */ "./src/js/components/fullpageswiper.js");
/* harmony import */ var _components_smoothscroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/smoothscroll */ "./src/js/components/smoothscroll.js");
...
/***/ "./src/js/components/fullpageswiper.js":
/*!*********************************************!*\
  !*** ./src/js/components/fullpageswiper.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const pageSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.well', {
  wrapperClass: 'well__wrapper',
  slideClass: 'well__panel',
  direction: 'vertical',
  slidesPerView: 'auto',
  mousewheel: true,
  keyboard: {
  ...
  on: {
    ...
    slideChange: function () {
      menuSlideRemove();
      menuLinks[pageSlider.realIndex].classList.add('menu-header__link_active');
    }
  }
});
let menuLinks = document.querySelectorAll('.menu-header__link');
function menuSlide() {
  if (menuLinks.length > 0) {
    ...
    for (let index = 0; index < menuLinks.length; index++) {
      ...
      menuLink.addEventListener('click', function (e) {
        ...
        menuLink.classList.add('menu-header__link_active');
        e.preventDefault();
      });
    }
  }
...
;
function menuSlideRemove() {
  let menuLinkActive = document.querySelector('.menu-header__link_active');
  if (menuLinkActive) {
    menuLinkActive.classList.remove('menu-header__link_active');
  }
}
;
pageSlider.init();
...
/***/ "./src/js/components/swiper-page2.js":
/*!*******************************************!*\
  !*** ./src/js/components/swiper-page2.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.model__swiper', {
  width: 1680,
  spaceBetween: 40,
  slidesPerView: '2',
  cssMode: true,
...
/* свайпер 3 страницы описания  */

const swiper1 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.description__swiper', {
  width: 525,
  spaceBetween: 40,
  cssMode: true,
  ...
  slidesPerView: 'auto',
  navigation: {
    nextEl: ".description__swiper-button-next",
    prevEl: ".description__swiper-button-prev"
  },
  pagination: {
    el: ".description__swiper-pagination",
    clickable: true,
    type: 'fraction',
...
const swiper2 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.model3d__swiper', {
  slideClass: 'model3d__slide',
  direction: 'vertical',
  slidesPerView: 'auto',
  cssMode: true,
  allowTouchMove: false,
  mousewheel: false,
  pagination: {
    el: ".model3d__pagination",
    clickable: true,
    type: "bullets",
    dynamicBullets: "true",
    dynamicMainBullets: 1,
    renderBullet: function (index, className) {
      return '<span class="' + className + '">' + "R44 I" + '</span>';
    }
  }
});
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.form-feedback', rules, afterForm);
